...
This application is built using ruby on rails 3, bootstrap, jquery, html, Sqlite etc. The features provided by the application are following,
...
3. Empowering doctors operating on a patient by providing them all the details like which other doctors and staff are working on
a patient and the details of their treatment.
